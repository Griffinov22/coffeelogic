        ...
        <p className="use-text">
          ...
          <ol className="pour-list">
            ...
            <li>
              ...
              <span>
                Use hot water from the sink to get the paper stuck to the sides
                of the device
              </span>
              . This way you save hot water for your actual brew.
            </li>
            <li>
              Great now add your grinded coffee following the 'Grind Size'
              section above, and prepare your water to approximately 198° If you
              want to get more from your brew:
            ...
            <li>
              ...
              final weight in water and split it into 5 pours. For example: If
              you were going to brew a yeti (21g to 350g) of coffee, you would
              have 5 pours of 70g each.
            </li>
            <li>
              ...
              completely saturate the grounds. Next, pick up your brew device
              and swirl it to incorporate your brew. Let the bloom sit until
              your timer hits 45s.
            </li>
            <li>
              Your next step is to pour your second section of water in the
              device by 1min on your timer. Start from the outside of coffee and
              pour in a circular direction. You should finish your pour in the
              middle. Wait 10s (you should be at 1:10).
            </li>
            <li>
